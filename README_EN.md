...
| `AI_STUDIO_APP_URL`             | AI Studio app URL to open (optional), in the format `https://ai.studio/apps/<app-id>`. Leave empty to use the built-in app. [Guide](docs/en/create-ai-studio-app.md)                                                                                                  | Built-in app |
